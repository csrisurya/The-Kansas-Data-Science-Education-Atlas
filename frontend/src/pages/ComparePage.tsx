  ...
  return (
    <div className="bg-white rounded-lg shadow p-8 relative min-h-[400px]">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-ksu-purple">Compare: County Profiles</h2>
        <button
      ...
      <div className="text-gray-600 text-lg">
        Main content area coming soon. Here you will be able to compare county profiles for data science and AI education.
      </div>
    </div>
  );
};
